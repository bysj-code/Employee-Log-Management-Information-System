<template>
	<div class="diy_details page_notification_list" id="notification_list_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_notification_list'>
							<div_notification_list :obj="obj"></div_notification_list>
...
<script>
	import div_notification_list from "@/components/diy/div_notification_list.vue";
		...
		methods:{
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.notification_list_id;
				}
			},
			/**
			 * 获取点赞
