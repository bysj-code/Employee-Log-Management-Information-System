<template>
	<div class="diy_home diy_list diy_clock_in" id="diy_clock_in_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/clock_in/details?clock_in_id=' + o['clock_in_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/clock_in/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/clock_in/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						性别
							...
							<th class="diy_title" v-if="$check_field('get','clock_type')">
						打卡类型
					</th>
							<th class="diy_title" v-if="$check_field('get','clocking_time')">
						打卡时间
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','clock_type')">
						<span>
							{{ o["clock_type"] }}
						</span>
					</td>
							<td class="diy_field diy_datetime" v-if="$check_field('get','clocking_time')">
						<span>
