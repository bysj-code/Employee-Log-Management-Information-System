<template>
	<div class="diy_details_box diy_div_task_arrangement">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/project_records/edit','add')" @click="to_form('/project_records/edit')" > 记录 </button>
										</div>
						<!-- 富文本 -->
