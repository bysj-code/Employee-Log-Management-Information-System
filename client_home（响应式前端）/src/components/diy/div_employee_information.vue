<template>
	<div class="diy_details_box diy_div_employee_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/task_arrangement/edit','add')" @click="to_form('/task_arrangement/edit')" > 分派 </button>
										</div>
						<!-- 富文本 -->
