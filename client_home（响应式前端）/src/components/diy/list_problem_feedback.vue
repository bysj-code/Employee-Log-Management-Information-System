<template>
	<div class="diy_home diy_list diy_problem_feedback" id="diy_problem_feedback_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/problem_feedback/details?problem_feedback_id=' + o['problem_feedback_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/problem_feedback/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/problem_feedback/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						员工姓名
							...
							<th class="diy_title" v-if="$check_field('get','feedback_time')">
						反馈时间
					</th>
							<th class="diy_title" v-if="$check_field('get','problem_description')">
						问题描述
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_date" v-if="$check_field('get','feedback_time')">
						<span>
							{{ $toTime(o["feedback_time"] ,"yyyy-MM-dd") }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','problem_description')">
						<span>
