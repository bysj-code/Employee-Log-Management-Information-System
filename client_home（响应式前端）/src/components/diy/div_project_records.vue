<template>
	<div class="diy_details_box diy_div_project_records">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/project_scoring/edit','add')" @click="to_form('/project_scoring/edit')" > 打分 </button>
										</div>
						<!-- 富文本 -->
