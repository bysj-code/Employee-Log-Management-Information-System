<template>
  <view class="page_notification_list diy_table diy_table_tml" id="notification_list_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/notification_list/view?" v-show="user_group == '管理员' || $check_action('/notification_list/table','add') || $check_action('/notification_list/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','publisher')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>发布人</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','content_related')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>内容相关</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/notification_list/table','del') || $check_action('/notification_list/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/notification_list/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/notification_list/table','set') || $check_action('/notification_list/view','set') || $check_action('/notification_list/view','get')" class="btn btn-primary">详情</navigator>
														</view>
			</view>
		</view>
	</view>
