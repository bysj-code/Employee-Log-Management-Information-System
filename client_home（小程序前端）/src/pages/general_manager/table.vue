<template>
  <view class="page_general_manager diy_table diy_table_tml" id="general_manager_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/general_manager/view?" v-show="user_group == '管理员' || $check_action('/general_manager/table','add') || $check_action('/general_manager/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/general_manager/table','del') || $check_action('/general_manager/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/general_manager/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/general_manager/table','set') || $check_action('/general_manager/view','set') || $check_action('/general_manager/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
