          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','general_manager_no') || $check_field('add','general_manager_no') || $check_field('set','general_manager_no')" label="总经理编号" name="general_manager_no">
                                <uni-easyinput type="text" v-model="form['general_manager_no']" v-if="user_group === '管理员' || (form['general_manager_id'] && $check_field('set','general_manager_no')) || (!form['general_manager_id'] && $check_field('add','general_manager_no'))" :disabled="disabledObj['general_manager_no_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','general_manager_no')">
                  {{ form['general_manager_no'] }}
                </text>
                            </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','full_name') || $check_field('add','full_name') || $check_field('set','full_name')" label="姓名" name="full_name">
                                <uni-easyinput type="text" v-model="form['full_name']" v-if="user_group === '管理员' || (form['general_manager_id'] && $check_field('set','full_name')) || (!form['general_manager_id'] && $check_field('add','full_name'))" :disabled="disabledObj['full_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','gender') || $check_field('add','gender') || $check_field('set','gender')" label="性别" name="gender">
                  ...
                  v-if="user_group === '管理员' || (form['general_manager_id'] && $check_field('set','gender')) || (!form['general_manager_id'] && $check_field('add','gender'))"
                ></uni-data-select>
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      url_add: "~/api/general_manager/add?",
      url_set: "~/api/general_manager/set?",
      url_get_obj: "~/api/general_manager/get_obj?",
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/general_manager/upload?'),
