<template>
	<view class="page_problem_feedback diy_list diy_list_page div_list_tml" id="problem_feedback_list">
		<!-- 筛选模块(开始) -->
		<view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?problem_feedback_id=' + o['problem_feedback_id']" class="btn btn-primary">查看详情</navigator>
