<template>
  <view class="page_problem_feedback diy_table diy_table_tml" id="problem_feedback_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/problem_feedback/view?" v-show="user_group == '管理员' || $check_action('/problem_feedback/table','add') || $check_action('/problem_feedback/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','feedback_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>反馈时间</span>
							</view>
								...
								<span>
									{{ $toTime(o["feedback_time"] ,"yyyy-MM-dd") }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','problem_description')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>问题描述</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/problem_feedback/table','del') || $check_action('/problem_feedback/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/problem_feedback/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/problem_feedback/table','set') || $check_action('/problem_feedback/view','set') || $check_action('/problem_feedback/view','get')" class="btn btn-primary">详情</navigator>
														</view>
			</view>
		</view>
	</view>
