<template>
  <view class="page_agency_tasks diy_table diy_table_tml" id="agency_tasks_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/agency_tasks/view?" v-show="user_group == '管理员' || $check_action('/agency_tasks/table','add') || $check_action('/agency_tasks/view','add')">添加</navigator>
                            ...
                            <span>标题</span>
								...
								<text>
									{{ o["title"] }}
													...
													<view v-if="0 && $check_field('get','general_manager_no')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>总经理编号</span>
                          </view>
								...
								<text>
									{{ get_user_general_manager_no(o['general_manager_no']) }}
								</text>
							</view>
										</view>
					</view>
                            ...
                            <span>任务名称</span>
								...
								<text>
									{{ o["task_name"] }}
													...
													<view v-if="0 && $check_field('get','creation_time')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>创建时间</span>
                          </view>
                            ...
                            <span>截止日期</span>
								...
								<text>
									{{ $toTime(o["closing_date"],"yyyy-MM-dd") }}
													...
													<view v-if="0 && $check_field('get','task_details')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>任务详情</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/agency_tasks/table','del') || $check_action('/agency_tasks/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/agency_tasks/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/agency_tasks/table','set') || $check_action('/agency_tasks/view','set') || $check_action('/agency_tasks/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
