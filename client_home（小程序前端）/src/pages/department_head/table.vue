<template>
  <view class="page_department_head diy_table diy_table_tml" id="department_head_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/department_head/view?" v-show="user_group == '管理员' || $check_action('/department_head/table','add') || $check_action('/department_head/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/department_head/table','del') || $check_action('/department_head/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/department_head/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/department_head/table','set') || $check_action('/department_head/view','set') || $check_action('/department_head/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
