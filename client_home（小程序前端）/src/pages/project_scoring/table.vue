<template>
  <view class="page_project_scoring diy_table diy_table_tml" id="project_scoring_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/project_scoring/view?" v-show="user_group == '管理员' || $check_action('/project_scoring/table','add') || $check_action('/project_scoring/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','scoring_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>打分时间</span>
							</view>
								...
								<span>
									{{ $toTime(o["scoring_time"] ,"yyyy-MM-dd") }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','fraction')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>分数</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/project_scoring/table','del') || $check_action('/project_scoring/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/project_scoring/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/project_scoring/table','set') || $check_action('/project_scoring/view','set') || $check_action('/project_scoring/view','get')" class="btn btn-primary">详情</navigator>
														</view>
			</view>
		</view>
	</view>
