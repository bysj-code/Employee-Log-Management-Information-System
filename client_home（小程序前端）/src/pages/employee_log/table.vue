<template>
  <view class="page_employee_log diy_table diy_table_tml" id="employee_log_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="日志标题" name="log_title">
                      <uni-easyinput type="text" v-model="query.log_title" placeholder="日志标题" />
                    </uni-forms-item>
                        </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/employee_log/view?" v-show="user_group == '管理员' || $check_action('/employee_log/table','add') || $check_action('/employee_log/view','add')">添加</navigator>
	...
	<view class="warp" >
		<view class="container">
			<view v-for="(o,i) in list" class="row box_style">
									<view class="col" v-if="1 && $check_field('get','log_title')">
						<view class="view">
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','content_details')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>内容详情</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/employee_log/table','del') || $check_action('/employee_log/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/employee_log/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/employee_log/table','set') || $check_action('/employee_log/view','set') || $check_action('/employee_log/view','get')" class="btn btn-primary">详情</navigator>
														</view>
			</view>
		</view>
	</view>
