<template>
	<view class="page_employee_log diy_list diy_list_page div_list_tml" id="employee_log_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索日志标题" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'log_title')">
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?employee_log_id=' + o['employee_log_id']" class="btn btn-primary">查看详情</navigator>
