<template>
  <view class="page_work_tracking diy_table diy_table_tml" id="work_tracking_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="标题" name="title">
                      ...
                      <uni-forms-item label="主管姓名" name="supervisor_name">
                      <uni-easyinput type="text" v-model="query.supervisor_name" placeholder="主管姓名" />
                    </uni-forms-item>
                      </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/work_tracking/view?" v-show="user_group == '管理员' || $check_action('/work_tracking/table','add') || $check_action('/work_tracking/view','add')">添加</navigator>
                            ...
                            <span>标题</span>
								...
								<text>
									{{ o["title"] }}
													...
													<view v-if="0 && $check_field('get','supervisor_no')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>主管编号</span>
                          </view>
								...
								<text>
									{{ get_user_supervisor_no(o['supervisor_no']) }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','supervisor_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>主管姓名</span>
                          </view>
								...
								<text>
									{{ o["supervisor_name"] }}
													...
													<view v-if="0 && $check_field('get','task_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>任务名称</span>
                          </view>
								...
								<text>
									{{ o["task_name"] }}
													...
													<view v-if="0 && $check_field('get','closing_date')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>截止日期</span>
                          </view>
								...
								<text>
									{{ $toTime(o["closing_date"],"yyyy-MM-dd") }}
													...
													<view v-if="0 && $check_field('get','tracking')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>追踪情况</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/work_tracking/table','del') || $check_action('/work_tracking/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/work_tracking/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/work_tracking/table','set') || $check_action('/work_tracking/view','set') || $check_action('/work_tracking/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
