<template>
  <view class="page_clock_in diy_table diy_table_tml" id="clock_in_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/clock_in/view?" v-show="user_group == '管理员' || $check_action('/clock_in/table','add') || $check_action('/clock_in/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','clock_type')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>打卡类型</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','clocking_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>打卡时间</span>
							</view>
								...
								<span>
									{{ $toTime(o["clocking_time"] ,"yyyy-MM-dd hh:mm:ss") }}
								</span>
								</view>
													</view>
					</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/clock_in/table','del') || $check_action('/clock_in/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/clock_in/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/clock_in/table','set') || $check_action('/clock_in/view','set') || $check_action('/clock_in/view','get')" class="btn btn-primary">详情</navigator>
														</view>
			</view>
		</view>
	</view>
