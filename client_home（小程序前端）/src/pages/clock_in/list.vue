<template>
	<view class="page_clock_in diy_list diy_list_page div_list_tml" id="clock_in_list">
		<!-- 筛选模块(开始) -->
		<view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?clock_in_id=' + o['clock_in_id']" class="btn btn-primary">查看详情</navigator>
			...
			return {
				url_get_list: "~/api/clock_in/get_list?like=0",
					...
					list_user_employee_id: [],
												// 打卡类型选项列表
				list_clock_type: [{value:"全部",text:"全部"}],
