<template>
	<view class="page_project_records diy_list diy_list_page div_list_tml" id="project_records_list">
		<!-- 筛选模块(开始) -->
		<view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?project_records_id=' + o['project_records_id']" class="btn btn-primary">查看详情</navigator>
			...
			return {
				url_get_list: "~/api/project_records/get_list?like=0",
					...
					list_user_employee_id: [],
														// 完成情况选项列表
				list_completion: [{value:"全部",text:"全部"}],
