		...
		<el-submenu index="user"
			...
			<el-menu-item index="/user/table" v-show="user_group == '管理员'"><span>管理员</span></el-menu-item>
						<el-menu-item index="/staff/table" v-show="user_group == '管理员' || $check_action('/staff/table')"><span>员工</span></el-menu-item>
													<el-menu-item index="/department_head/table" v-show="user_group == '管理员' || $check_action('/department_head/table')"><span>部门主管</span></el-menu-item>
										<el-menu-item index="/general_manager/table" v-show="user_group == '管理员' || $check_action('/general_manager/table')"><span>总经理</span></el-menu-item>
