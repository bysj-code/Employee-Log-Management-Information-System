		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="总经理编号" prop="general_manager_no">
												<el-input id="general_manager_no" v-model="form_sub['general_manager_no']" placeholder="请输入总经理编号"
							  v-if="user_group === '管理员' || (form_sub['general_manager_id'] && $check_field('set','general_manager_no')) || (!form_sub['general_manager_id'] && $check_field('add','general_manager_no'))"></el-input>
					<div v-else-if="$check_field('get','general_manager_no')">{{form_sub['general_manager_no']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="姓名" prop="full_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['general_manager_id'] && $check_field('set','full_name')) || (!form_sub['general_manager_id'] && $check_field('add','full_name'))"></el-input>
				...
				<el-form-item label="性别" prop="gender">
						...
						v-if="user_group === '管理员' || (form_sub['general_manager_id'] && $check_field('set','gender')) || (!form_sub['general_manager_id'] && $check_field('add','gender'))">
