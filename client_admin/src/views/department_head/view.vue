		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="主管编号" prop="supervisor_no">
												<el-input id="supervisor_no" v-model="form_sub['supervisor_no']" placeholder="请输入主管编号"
							  v-if="user_group === '管理员' || (form_sub['department_head_id'] && $check_field('set','supervisor_no')) || (!form_sub['department_head_id'] && $check_field('add','supervisor_no'))"></el-input>
					<div v-else-if="$check_field('get','supervisor_no')">{{form_sub['supervisor_no']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="主管姓名" prop="supervisor_name">
												<el-input id="supervisor_name" v-model="form_sub['supervisor_name']" placeholder="请输入主管姓名"
							  v-if="user_group === '管理员' || (form_sub['department_head_id'] && $check_field('set','supervisor_name')) || (!form_sub['department_head_id'] && $check_field('add','supervisor_name'))"></el-input>
					<div v-else-if="$check_field('get','supervisor_name')">{{form_sub['supervisor_name']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="性别" prop="gender">
						...
						v-if="user_group === '管理员' || (form_sub['department_head_id'] && $check_field('set','gender')) || (!form_sub['department_head_id'] && $check_field('add','gender'))">
